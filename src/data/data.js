const portfolioData = [
	{
		...
		nav_links: [
			{ url: '/', link_text: 'Home' },
			{ url: '/work', link_text: 'Work' },
			{ url: '/about', link_text: 'About' },
			{ url: '/contact', link_text: 'Contact' },
		],
		social_media: [
			{
				platform: 'LinkedIn',
			...
			},
			{
				platform: 'Twitter',
				user_name: 'mr_rymer',
				acct_url: 'https://twitter.com/mr_rymer',
			},
		],
		jobs: [
			{
		...
		education: [
			...
			},
			{
				school: 'NYC College of Technology',
				school_location: 'Brooklyn, NY',
				field_of_study: 'HTML & CSS for Web Development',
				grad_date: 'September, 2019',
			},
			{
				school: 'NYC College of Technology',
				school_location: 'Brooklyn, NY',
